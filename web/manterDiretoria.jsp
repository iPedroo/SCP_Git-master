<%-- 
    Document   : AdicionarDiretoria
    Created on : 09/09/2014, 20:28:44
    Author     : Pedro
--%>
...
<html>
    <head>
        ...
        <title>SCP - Adicionar Diretoria</title>        
    </head>
    <body>
        <h1 align="center">SCP - Sistema de Controle de Projetos</h1>
        <h3 align="center">Adicionar Diretoria</h3>
